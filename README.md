...
<p align="left">
  <img src="https://skillicons.dev/icons?i=c,cpp,html,css,js,typescript,react,redux,nextjs,prisma,tailwind,bootstrap,nodejs,express,mysql,sqlite,postgres,mongodb,stackoverflow,java,spring,vercel,nginx,docker,aws,kafka,figma,bash,powershell,linux,git,github,postman,npm,vite,vscode,windows,idea,graphql,go" />
</p>
